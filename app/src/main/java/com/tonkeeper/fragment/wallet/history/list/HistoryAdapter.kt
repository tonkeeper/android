...
import com.tonkeeper.fragment.wallet.history.list.holder.HistoryActionHolder
import com.tonkeeper.fragment.wallet.history.list.holder.HistoryHeaderHolder
...
): BaseListAdapter<HistoryItem>(items) {

...
import com.tonapps.extensions.getOrLoad
import com.tonapps.extensions.map
import com.tonapps.icu.Coins
import com.tonapps.log.L
import com.tonapps.network.get
import com.tonapps.network.postJSON
import com.tonapps.wallet.api.backoff.ExponentialBackoff
...
class TronApi(
    ...
    private val resourcePricesCache = TimedCacheMemory<TronResourcePrices>()
    ...
    private suspend fun getResourcePrices(): TronResourcePrices {
        return resourcePricesCache.getOrLoad(RESOURCE_PRICES_KEY) {
            val builder = config.tronApiUrl.toUri().buildUpon()

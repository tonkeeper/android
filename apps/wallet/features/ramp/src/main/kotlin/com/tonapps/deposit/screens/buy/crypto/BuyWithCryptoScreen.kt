            ...
            Column(
                ...
                MoonBundleCell(
                    ...
                    Column(
                        ...
                        if (data?.memoTitle != null && data.memoValue != null) {
                            Row(
                                ...
                                Row(
                                    ...
                                    MoonActionIcon(
                                        ...
                                        onClick = { clipboard.copy(payinAddressAnnotated.toString()) },
                                        size = 28.dp,
                                        tintColor = UIKit.colorScheme.icon.secondary,
                                        contentDescription = "Navigation"
                                    )
                            ...
                            Row(
                                ...
                                Column(
                                    ...
                                    Row(
                                        ...
                                        MoonLabel(
                                            text = stringResource(Localization.required),
                                            colors = MoonLabelDefault.orange(),
                                        )
                                    }
                                ...
                                Row(
                                    ...
                                    MoonActionIcon(
                                        painter = painterResource(id = UIKitIcon.ic_copy_16),
                                        onClick = { clipboard.copy(data.memoValue) },
                                        size = 28.dp,
                                        tintColor = UIKit.colorScheme.icon.secondary,
                                        contentDescription = "Navigation"
                                    )
                            ...
                            val copyDetailsText = buildString {
                                append(from.code)
                                append(' ')
                                append(from.title)
                                append(" address:\n")
                                append(payinAddress)
                                append("\n\n")
                                append(data.memoTitle)
                                append(":\n")
                                append(data.memoValue)
                            }

                            MoonAccentButton(
                                modifier = Modifier.fillMaxWidth(),
                                text = stringResource(Localization.copy_details),
                                icon = {
                                    MoonItemIcon(
                            ...
                            ) { clipboard.copy(copyDetailsText) }
                        } else {
                            Column(
                                modifier = Modifier.fillMaxWidth(),
                                horizontalAlignment = Alignment.CenterHorizontally,

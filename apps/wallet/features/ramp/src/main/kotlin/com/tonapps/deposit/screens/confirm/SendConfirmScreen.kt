        ...
        Column(
            ...
            when {
                ...
                state.token != null -> {
                    ...
                    Text(
                        text = stringResource(Localization.jetton_transfer, CurrencyFormatter.displaySymbol(state.token.symbol)),
...
private fun HeaderCell(
    ...
    val sendLabel = stringResource(
        ...
        CurrencyFormatter.displaySymbol(from.code),
    )
    val receiveLabel = stringResource(
        Localization.receive_currency,
        CurrencyFormatter.displaySymbol(to.code),
    )

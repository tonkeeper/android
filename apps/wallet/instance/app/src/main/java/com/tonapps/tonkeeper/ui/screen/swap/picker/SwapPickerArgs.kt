...
data class SwapPickerArgs(
    ...
    val send: Boolean,
    val currencies: List<WalletCurrency>? = null,
): BaseArgs() {
    ...
    constructor(bundle: Bundle) : this(
        ...
        currencies = bundle.getParcelableArrayList(ARG_CURRENCIES),
    )
    ...
    override fun toBundle() = Bundle().apply {
        ...
        currencies?.let { putParcelableArrayList(ARG_CURRENCIES, ArrayList(it)) }
    }
}

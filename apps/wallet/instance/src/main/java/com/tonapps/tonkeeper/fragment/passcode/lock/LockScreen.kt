package com.tonapps.tonkeeper.fragment.passcode.lock
...
class LockScreen: BaseFragment(R.layout.fragment_passcode) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        titleView.setText(Localization.passcode_enter)
    ...
    private fun checkCode(code: String) {
        ...
        lifecycleScope.launch {
            if (com.tonapps.tonkeeper.App.passcode.compare(code)) {
    ...
    override fun onResume() {
        super.onResume()
        if (com.tonapps.tonkeeper.App.settings.biometric) {
            requestBiometric()
        }
    }
    ...
    private fun requestBiometric() {
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            .setTitle(getString(Localization.app_name))
            .setNegativeButtonText(getString(Localization.cancel))

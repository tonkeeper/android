...
class ReceiveScreen: UiScreen<ReceiveScreenState, ReceiveScreenEffect, ReceiveScreenFeature>(R.layout.fragment_receive), BaseFragment.BottomSheet {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val title = jetton?.jetton?.name ?: getString(Localization.toncoin)

        receiveTitleView.text = getString(Localization.receive_coin, title)
        receiveDescriptionView.text = getString(Localization.receive_coin_description, title)
    }

...
class CurrencyManager {
    ...
    suspend fun getRate24h(
        ...
        return getRate24h(accountId, testnet, token.name, currency.name)
    }
    ...
    suspend fun getRate7d(
        ...
        return getRate7d(accountId, testnet, token.name, currency.name)
    }
    ...
    suspend fun getRate(
        ...
        return getRate(accountId, testnet, token.name, currency.name)
    }

package com.tonkeeper.fragment.signer.add
...
import com.tonkeeper.core.signer.SignerApp
...
class SignerAddFragment: BaseFragment(R.layout.fragment_signer_add), BaseFragment.BottomSheet {

    companion object {
        fun newInstance() = SignerAddFragment()
    }

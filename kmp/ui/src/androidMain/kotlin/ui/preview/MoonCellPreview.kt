...
@Preview
@Composable
private fun MoonExpandableTextPreview() {
    ThemedPreview {
        Column(
            modifier = Modifier.padding(16.dp),
            ...
            MoonExpandableText(
                text = "Short message that fits in two lines without any truncation.",
                backgroundColor = UIKit.colorScheme.background.page,
                style = UIKit.typography.body2,
                color = UIKit.colorScheme.text.secondary,
                showMoreColor = UIKit.colorScheme.accent.blue,
                showMoreText = "More",
            )
            MoonExpandableText(
                text = "This is a long description that should overflow the two-line cap so that the Show more trigger sticks right next to the last visible word on line two of the label.",
                backgroundColor = UIKit.colorScheme.background.page,
                style = UIKit.typography.body2,
                color = UIKit.colorScheme.text.secondary,
                showMoreColor = UIKit.colorScheme.accent.blue,
            ...
            MoonExpandableText(
                text = "Another long paragraph demonstrating the single-line variant where the trigger sits immediately after the last visible word on line one.",
                backgroundColor = UIKit.colorScheme.background.page,
                style = UIKit.typography.body2,
                color = UIKit.colorScheme.text.secondary,
                showMoreColor = UIKit.colorScheme.accent.blue,

...
class DefaultEvents(
    ...
    class AssetScreenImpl(
         ...
         */
        @UiThread
        override fun assetView(from: AssetScreenFrom, asset: String) {
            trackEvent("asset_view", hashMapOf("from" to from.key, "asset" to asset))
        }
    ...
    class TradeUiFlowImpl(
         ...
         */
        @UiThread
        override fun tradeStarted(from: TradeUiFlowFrom) {
         ...
         */
        @UiThread
        override fun tradeClickAsset(from: TradeUiFlowFrom, asset: String) {
         ...
         */
        @UiThread
        override fun tradeSearch(from: TradeUiFlowFrom, query: String?) {
         ...
         */
        @UiThread
        override fun tradeSearchClick(from: TradeUiFlowFrom, query: String?, asset: String) {
...
Figma: Buy_ton_with_crypto / Send_token (for TON), or Stablecoin / Send_asset (for USDT)
    ...
    class LaunchAppImpl(
         ...
         */
        @UiThread
        override fun launchApp(featureFlags: String?) {
            val props = mutableMapOf<String, Any>()
            featureFlags?.let { props["feature_flags"] = it }

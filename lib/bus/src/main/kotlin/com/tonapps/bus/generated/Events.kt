...
interface Events {
    ...
    interface AssetScreen {
        ...
        /** asset_view */
        fun assetView(from: AssetScreenFrom, asset: String)
    ...
    interface LaunchApp {
        ...
        /** launch_app */
        fun launchApp(featureFlags: String?)
    }
    ...
    interface TradeUiFlow {
        ...
        enum class TradeUiFlowFrom(val key: String) {
            WalletScreen("wallet_screen"),
            JettonScreen("jetton_screen"),
            TabBar("tab_bar"),
            DeepLink("deep_link"),
        ...
        /** trade_started */
        fun tradeStarted(from: TradeUiFlowFrom)

        /** trade_click_asset */
        fun tradeClickAsset(from: TradeUiFlowFrom, asset: String)

        /** trade_search */
        fun tradeSearch(from: TradeUiFlowFrom, query: String?)

        /** trade_search_click */
        fun tradeSearchClick(from: TradeUiFlowFrom, query: String?, asset: String)
    }

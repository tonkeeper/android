...
class DefaultApi(
    ...
    fun androidBatteryPurchaseWithHttpInfo(
        xTonConnectAuth: String,
        androidBatteryPurchaseRequest: AndroidBatteryPurchaseRequest
    ): ApiResponse<AndroidBatteryPurchaseStatus?> {
    ...
    fun androidBatteryPurchaseRequestConfig(
        xTonConnectAuth: String,
        androidBatteryPurchaseRequest: AndroidBatteryPurchaseRequest
    ): RequestConfig<AndroidBatteryPurchaseRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun applyPromoWithHttpInfo(
        token: String,
        applyPromoRequest: ApplyPromoRequest
    ): ApiResponse<PromoCodeBatteryPurchaseStatus?> {
    ...
    fun applyPromoRequestConfig(
        token: String,
        applyPromoRequest: ApplyPromoRequest
    ): RequestConfig<ApplyPromoRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createCustomRefundWithHttpInfo(
        token: String,
        createCustomRefundRequest: CreateCustomRefundRequest
    ): ApiResponse<Map<String, io.JsonAny>?> {
    ...
    fun createCustomRefundRequestConfig(
        token: String,
        createCustomRefundRequest: CreateCustomRefundRequest
    ): RequestConfig<CreateCustomRefundRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createPromoCampaignWithHttpInfo(
        token: String,
        createPromoCampaignRequest: CreatePromoCampaignRequest
    ): ApiResponse<CreatePromoCampaign200Response?> {
    ...
    fun createPromoCampaignRequestConfig(
        token: String,
        createPromoCampaignRequest: CreatePromoCampaignRequest
    ): RequestConfig<CreatePromoCampaignRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun enterpriseEstimateWithHttpInfo(
        xEnterpriseAuth: String,
        walletId: String,
        enterpriseEstimateRequest: EnterpriseEstimateRequest,
        acceptLanguage: String?,
        emulate: Boolean?
    ): ApiResponse<EnterpriseEstimate200Response?> {
    ...
    fun enterpriseEstimateRequestConfig(
        xEnterpriseAuth: String,
        walletId: String,
        enterpriseEstimateRequest: EnterpriseEstimateRequest,
        acceptLanguage: String?,
        emulate: Boolean?
    ): RequestConfig<EnterpriseEstimateRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun enterpriseGetMessageWithHttpInfo(
        xEnterpriseAuth: String,
        msgId: String
    ): ApiResponse<EnterpriseGetMessage200Response?> {
    ...
    fun enterpriseGetMessageRequestConfig(
        xEnterpriseAuth: String,
        msgId: String
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun enterpriseGetWalletConfigWithHttpInfo(
        xEnterpriseAuth: String,
        walletId: String
    ): ApiResponse<EnterpriseWalletConfig?> {
    ...
    fun enterpriseGetWalletConfigRequestConfig(
        xEnterpriseAuth: String,
        walletId: String
    ): RequestConfig<Unit> {
        val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun enterpriseSendWithHttpInfo(
        xEnterpriseAuth: String,
        walletId: String,
        enterpriseEstimateRequest: EnterpriseEstimateRequest
    ): ApiResponse<EnterpriseSend200Response?> {
    ...
    fun enterpriseSendRequestConfig(
        xEnterpriseAuth: String,
        walletId: String,
        enterpriseEstimateRequest: EnterpriseEstimateRequest
    ): RequestConfig<EnterpriseEstimateRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun estimateGaslessCostWithHttpInfo(
        jettonMaster: String,
        estimateGaslessCostRequest: EstimateGaslessCostRequest,
        xTonConnectAuth: String?,
    ...
    fun estimateGaslessCostRequestConfig(
        jettonMaster: String,
        estimateGaslessCostRequest: EstimateGaslessCostRequest,
        xTonConnectAuth: String?,
        walletAddress: String?,
        walletPublicKey: String?,
        enableValidation: Boolean?
    ): RequestConfig<EstimateGaslessCostRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun extendRefundPeriodWithHttpInfo(
        purchaseId: Long,
        token: String
    ): ApiResponse<Map<String, io.JsonAny>?> {
    ...
    fun getBalance(
        xTonConnectAuth: String,
        units: UnitsGetBalance? = UnitsGetBalance.usd,
        region: String? = null
    ): Balance {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getBalanceWithHttpInfo(
        xTonConnectAuth: String,
        units: UnitsGetBalance?,
        region: String?
    ): ApiResponse<Balance?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getTransactionsWithHttpInfo(
        xTonConnectAuth: String,
        limit: Int?,
        offset: Int?
    ...
    fun getTransactionsRequestConfig(
        xTonConnectAuth: String,
        limit: Int?,
        offset: Int?
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getTronTransactionsWithHttpInfo(
        xTonConnectAuth: String,
        limit: Int?,
        maxTimestamp: Long?
    ): ApiResponse<TronTransactionsList?> {
    ...
    fun getTronTransactionsRequestConfig(
        xTonConnectAuth: String,
        limit: Int?,
        maxTimestamp: Long?
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun increaseUserBalanceWithHttpInfo(
        userId: Long,
        token: String,
        increaseUserBalanceRequest: IncreaseUserBalanceRequest
    ): ApiResponse<Map<String, io.JsonAny>?> {
    ...
    fun increaseUserBalanceRequestConfig(
        userId: Long,
        token: String,
        increaseUserBalanceRequest: IncreaseUserBalanceRequest
    ): RequestConfig<IncreaseUserBalanceRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun iosBatteryPurchaseWithHttpInfo(
        xTonConnectAuth: String,
        iosBatteryPurchaseRequest: IosBatteryPurchaseRequest
    ): ApiResponse<IOSBatteryPurchaseStatus?> {
    ...
    fun iosBatteryPurchaseRequestConfig(
        xTonConnectAuth: String,
        iosBatteryPurchaseRequest: IosBatteryPurchaseRequest
    ): RequestConfig<IosBatteryPurchaseRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun promoCodeBatteryPurchaseWithHttpInfo(
        xTonConnectAuth: String,
        promoCodeBatteryPurchaseRequest: PromoCodeBatteryPurchaseRequest,
        acceptLanguage: String?
    ): ApiResponse<PromoCodeBatteryPurchaseStatus?> {
    ...
    fun promoCodeBatteryPurchaseRequestConfig(
        xTonConnectAuth: String,
        promoCodeBatteryPurchaseRequest: PromoCodeBatteryPurchaseRequest,
        acceptLanguage: String?
    ): RequestConfig<PromoCodeBatteryPurchaseRequest> {
    ...
    fun requestRefundRequestConfig(
        xTonConnectAuth: String,
        requestRefundRequest: RequestRefundRequest
    ): RequestConfig<RequestRefundRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun resetUserBalanceWithHttpInfo(
        userId: Long,
        token: String,
        resetUserBalanceRequest: ResetUserBalanceRequest
    ): ApiResponse<Map<String, io.JsonAny>?> {
    ...
    fun resetUserBalanceRequestConfig(
        userId: Long,
        token: String,
        resetUserBalanceRequest: ResetUserBalanceRequest
    ): RequestConfig<ResetUserBalanceRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun tronEstimateWithHttpInfo(
        wallet: String,
        xTonConnectAuth: String?,
        energy: Int?,
        bandwidth: Int?,
        enableValidation: Boolean?
    ): ApiResponse<EstimatedTronTx?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun tronSendWithHttpInfo(
        tronSendRequest: TronSendRequest,
        xTonConnectAuth: String?,
        userPublicKey: String?
    ): ApiResponse<SentTronTx?> {
    ...
    fun tronSendRequestConfig(
        tronSendRequest: TronSendRequest,
        xTonConnectAuth: String?,
        userPublicKey: String?
    ): RequestConfig<TronSendRequest> {

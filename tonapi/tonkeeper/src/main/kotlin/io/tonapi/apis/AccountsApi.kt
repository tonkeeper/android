...
class AccountsApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun emulateMessageToAccountEventWithHttpInfo(
        accountId: String,
        gaslessEstimateRequestMessagesInner: GaslessEstimateRequestMessagesInner,
        acceptLanguage: String?,
        ignoreSignatureCheck: Boolean?
    ): ApiResponse<AccountEvent?> {
    ...
    fun emulateMessageToAccountEventRequestConfig(
        accountId: String,
        gaslessEstimateRequestMessagesInner: GaslessEstimateRequestMessagesInner,
        acceptLanguage: String?,
        ignoreSignatureCheck: Boolean?
    ): RequestConfig<GaslessEstimateRequestMessagesInner> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountDiffWithHttpInfo(
        accountId: String,
        startDate: Long,
        endDate: Long
    ): ApiResponse<GetAccountDiff200Response?> {
    ...
    fun getAccountDiffRequestConfig(
        accountId: String,
        startDate: Long,
        endDate: Long
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountDnsExpiringWithHttpInfo(
        accountId: String,
        period: Int?
    ): ApiResponse<DnsExpiring?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountEventWithHttpInfo(
        accountId: String,
        eventId: String,
        acceptLanguage: String?,
        subjectOnly: Boolean?
    ...
    fun getAccountEventRequestConfig(
        accountId: String,
        eventId: String,
        acceptLanguage: String?,
        subjectOnly: Boolean?
    ...
    fun getAccountEvents(
        ...
        startDate: Long? = null,
        endDate: Long? = null,
        sortOrder: SortOrderGetAccountEvents? = SortOrderGetAccountEvents.desc
    ): AccountEvents {
        val localVarResponse = getAccountEventsWithHttpInfo(
            accountId = accountId,
            limit = limit,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountEventsWithHttpInfo(
        accountId: String,
        limit: Int,
        acceptLanguage: String?,
        initiator: Boolean?,
        ...
        startDate: Long?,
        endDate: Long?,
        sortOrder: SortOrderGetAccountEvents?
    ): ApiResponse<AccountEvents?> {
        val localVariableConfig = getAccountEventsRequestConfig(
            accountId = accountId,
            limit = limit,
            acceptLanguage = acceptLanguage,
            initiator = initiator,
    ...
    fun getAccountEventsRequestConfig(
        accountId: String,
        limit: Int,
        acceptLanguage: String?,
        initiator: Boolean?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAccountExtraCurrencyHistoryByID(
        accountId: String,
        id: Int,
        limit: Int,
        acceptLanguage: String? = "en",
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountExtraCurrencyHistoryByIDWithHttpInfo(
        accountId: String,
        id: Int,
        limit: Int,
        acceptLanguage: String?,
    ...
    fun getAccountExtraCurrencyHistoryByIDRequestConfig(
        accountId: String,
        id: Int,
        limit: Int,
        acceptLanguage: String?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAccountJettonBalance(
        accountId: String,
        jettonId: String,
        currencies: List<String>? = null,
        supportedExtensions: List<String>? = null
    ): JettonBalance {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountJettonBalanceWithHttpInfo(
        accountId: String,
        jettonId: String,
        currencies: List<String>?,
        supportedExtensions: List<String>?
    ): ApiResponse<JettonBalance?> {
    ...
    fun getAccountJettonBalanceRequestConfig(
        accountId: String,
        jettonId: String,
        currencies: List<String>?,
        supportedExtensions: List<String>?
    ...
    fun getAccountJettonHistoryByID(
        accountId: String,
        jettonId: String,
        limit: Int,
        acceptLanguage: String? = "en",
    ...
    @Throws(IllegalStateException::class, IOException::class)
    @Deprecated(message = "This operation is deprecated.")
    fun getAccountJettonHistoryByIDWithHttpInfo(
        accountId: String,
        jettonId: String,
        limit: Int,
        acceptLanguage: String?,
    ...
    @Deprecated(message = "This operation is deprecated.")
    fun getAccountJettonHistoryByIDRequestConfig(
        accountId: String,
        jettonId: String,
        limit: Int,
        acceptLanguage: String?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountJettonsBalancesWithHttpInfo(
        accountId: String,
        currencies: List<String>?,
        supportedExtensions: List<String>?
    ): ApiResponse<JettonsBalances?> {
    ...
    fun getAccountJettonsBalancesRequestConfig(
        accountId: String,
        currencies: List<String>?,
        supportedExtensions: List<String>?
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountJettonsHistoryWithHttpInfo(
        accountId: String,
        limit: Int,
        beforeLt: Long?
    ): ApiResponse<JettonOperations?> {
    ...
    fun getAccountJettonsHistoryRequestConfig(
        accountId: String,
        limit: Int,
        beforeLt: Long?
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAccountNftItems(
        accountId: String,
        collection: String? = null,
        limit: Int? = 1000,
        offset: Int? = 0,
        indirectOwnership: Boolean? = false
    ): NftItems {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountNftItemsWithHttpInfo(
        accountId: String,
        collection: String?,
        limit: Int?,
        offset: Int?,
        indirectOwnership: Boolean?
    ): ApiResponse<NftItems?> {
    ...
    fun getAccountNftItemsRequestConfig(
        accountId: String,
        collection: String?,
        limit: Int?,
        offset: Int?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountTracesWithHttpInfo(
        accountId: String,
        beforeLt: Long?,
        limit: Int?
    ): ApiResponse<TraceIDs?> {
    ...
    fun getAccountTracesRequestConfig(
        accountId: String,
        beforeLt: Long?,
        limit: Int?
    ): RequestConfig<Unit> {
    ...
    fun getAccounts(
        ...
        getAccountsRequest: GetAccountsRequest? = null
    ): Accounts {
    ...
    fun getAccountsRequestConfig(
        currency: String?,
        getAccountsRequest: GetAccountsRequest?
    ): RequestConfig<GetAccountsRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getJettonAccountHistoryByID(
        accountId: String,
        jettonId: String,
        limit: Int,
        beforeLt: Long? = null,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getJettonAccountHistoryByIDWithHttpInfo(
        accountId: String,
        jettonId: String,
        limit: Int,
        beforeLt: Long?,
    ...
    fun getJettonAccountHistoryByIDRequestConfig(
        accountId: String,
        jettonId: String,
        limit: Int,
        beforeLt: Long?,

...
class AccountsApi(basePath: String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAccounts(currency: String? = null, getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest? = null): Accounts {
        val localVarResponse = getAccountsWithHttpInfo(currency = currency, getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAccountsWithHttpInfo(currency: String?, getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): ApiResponse<Accounts?> {
        val localVariableConfig = getAccountsRequestConfig(currency = currency, getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)

        return request<GetBlockchainRawAccountsRequest, Accounts>(
            localVariableConfig
        )
    }

    fun getAccountsRequestConfig(currency: String?, getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): RequestConfig<GetBlockchainRawAccountsRequest> {

...
import io.tonapi.models.BlockchainRawAccounts
...
class BlockchainApi(basePath: String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBlockchainMasterchainTransactions(masterchainSeqno: Int, offset: Int? = 0, limit: Int? = null): Transactions {
        val localVarResponse = getBlockchainMasterchainTransactionsWithHttpInfo(masterchainSeqno = masterchainSeqno, offset = offset, limit = limit)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getBlockchainMasterchainTransactionsWithHttpInfo(masterchainSeqno: Int, offset: Int?, limit: Int?): ApiResponse<Transactions?> {
        val localVariableConfig = getBlockchainMasterchainTransactionsRequestConfig(masterchainSeqno = masterchainSeqno, offset = offset, limit = limit)
    ...
    fun getBlockchainMasterchainTransactionsRequestConfig(masterchainSeqno: Int, offset: Int?, limit: Int?): RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
            .apply {
                if (offset != null) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBlockchainRawAccounts(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest? = null): BlockchainRawAccounts {
        val localVarResponse = getBlockchainRawAccountsWithHttpInfo(getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as BlockchainRawAccounts
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getBlockchainRawAccountsWithHttpInfo(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): ApiResponse<BlockchainRawAccounts?> {
        val localVariableConfig = getBlockchainRawAccountsRequestConfig(getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)

        return request<GetBlockchainRawAccountsRequest, BlockchainRawAccounts>(
            localVariableConfig
        )
    }

    fun getBlockchainRawAccountsRequestConfig(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): RequestConfig<GetBlockchainRawAccountsRequest> {

...
class BlockchainApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun execGetMethodForBlockchainAccount(
        accountId: String,
        methodName: String,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun execGetMethodForBlockchainAccountWithHttpInfo(
        accountId: String,
        methodName: String,
        args: List<String>?
    ): ApiResponse<MethodExecutionResult?> {
    ...
    fun execGetMethodForBlockchainAccountRequestConfig(
        accountId: String,
        methodName: String,
        args: List<String>?
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun execGetMethodWithBodyForBlockchainAccount(
        accountId: String,
        methodName: String,
        execGetMethodWithBodyForBlockchainAccountRequest: ExecGetMethodWithBodyForBlockchainAccountRequest? = null
    ): MethodExecutionResult {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun execGetMethodWithBodyForBlockchainAccountWithHttpInfo(
        accountId: String,
        methodName: String,
    ...
    fun execGetMethodWithBodyForBlockchainAccountRequestConfig(
        accountId: String,
        methodName: String,
        execGetMethodWithBodyForBlockchainAccountRequest: ExecGetMethodWithBodyForBlockchainAccountRequest?
    ): RequestConfig<ExecGetMethodWithBodyForBlockchainAccountRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBlockchainAccountTransactions(
        accountId: String,
        afterLt: Long? = null,
        beforeLt: Long? = null,
        limit: Int? = 100,
        sortOrder: SortOrderGetBlockchainAccountTransactions? = SortOrderGetBlockchainAccountTransactions.desc
    ): Transactions {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getBlockchainAccountTransactionsWithHttpInfo(
        accountId: String,
        afterLt: Long?,
        beforeLt: Long?,
        limit: Int?,
        sortOrder: SortOrderGetBlockchainAccountTransactions?
    ...
    fun getBlockchainAccountTransactionsRequestConfig(
        accountId: String,
        afterLt: Long?,
        beforeLt: Long?,
        limit: Int?,

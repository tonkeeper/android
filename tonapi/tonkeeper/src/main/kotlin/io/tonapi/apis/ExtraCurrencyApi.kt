...
class ExtraCurrencyApi(basePath: String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun getExtraCurrencyInfo(id: Int): EcPreview {
    ...
    fun getExtraCurrencyInfoWithHttpInfo(id: Int): ApiResponse<EcPreview?> {
    ...
    fun getExtraCurrencyInfoRequestConfig(id: Int): RequestConfig<Unit> {

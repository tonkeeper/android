...
class JettonsApi(basePath: String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getJettonInfosByAddresses(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest? = null): Jettons {
        val localVarResponse = getJettonInfosByAddressesWithHttpInfo(getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getJettonInfosByAddressesWithHttpInfo(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): ApiResponse<Jettons?> {
        val localVariableConfig = getJettonInfosByAddressesRequestConfig(getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)

        return request<GetBlockchainRawAccountsRequest, Jettons>(
            localVariableConfig
        )
    }

    fun getJettonInfosByAddressesRequestConfig(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): RequestConfig<GetBlockchainRawAccountsRequest> {

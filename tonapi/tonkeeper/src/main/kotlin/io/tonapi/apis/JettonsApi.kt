...
class JettonsApi(
    ...
    fun getJettonHoldersWithHttpInfo(
        accountId: String,
        limit: Int?,
        offset: Int?
    ): ApiResponse<JettonHolders?> {
    ...
    fun getJettonHoldersRequestConfig(
        accountId: String,
        limit: Int?,
        offset: Int?
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getJettonTransferPayloadWithHttpInfo(
        accountId: String,
        jettonId: String
    ): ApiResponse<JettonTransferPayload?> {
    ...
    fun getJettonTransferPayloadRequestConfig(
        accountId: String,
        jettonId: String
    ): RequestConfig<Unit> {
        val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getJettonsEventsWithHttpInfo(
        eventId: String,
    ...
    fun getJettonsEventsRequestConfig(
        eventId: String,
        acceptLanguage: String?
    ): RequestConfig<Unit> {
        val localVariableBody = null

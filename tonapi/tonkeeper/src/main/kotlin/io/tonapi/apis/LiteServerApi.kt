...
class LiteServerApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRawAccountStateWithHttpInfo(
        accountId: String,
        targetBlock: String?
    ): ApiResponse<GetRawAccountState200Response?> {
    ...
    fun getRawAccountStateRequestConfig(
        accountId: String,
        targetBlock: String?
    ): RequestConfig<Unit> {
        val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRawBlockProofWithHttpInfo(
        knownBlock: String,
        mode: Int,
        targetBlock: String?
    ): ApiResponse<GetRawBlockProof200Response?> {
    ...
    fun getRawBlockProofRequestConfig(
        knownBlock: String,
        mode: Int,
        targetBlock: String?
    ): RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getRawBlockchainBlockHeader(
        blockId: String,
        mode: Int
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRawBlockchainBlockHeaderWithHttpInfo(
        blockId: String,
        mode: Int
    ): ApiResponse<GetRawBlockchainBlockHeader200Response?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRawConfigWithHttpInfo(
        blockId: String,
        mode: Int
    ): ApiResponse<GetRawConfig200Response?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getRawListBlockTransactions(
        blockId: String,
        mode: Int,
        count: Int,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRawListBlockTransactionsWithHttpInfo(
        blockId: String,
        mode: Int,
        count: Int,
        accountId: String?,
        lt: Long?
    ): ApiResponse<GetRawListBlockTransactions200Response?> {
    ...
    fun getRawListBlockTransactionsRequestConfig(
        blockId: String,
        mode: Int,
        count: Int,
        accountId: String?,
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRawShardInfoWithHttpInfo(
        blockId: String,
        workchain: Int,
        shard: Long,
        exact: Boolean
    ): ApiResponse<GetRawShardInfo200Response?> {
    ...
    fun getRawShardInfoRequestConfig(
        blockId: String,
        workchain: Int,
        shard: Long,
        exact: Boolean
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRawTransactionsWithHttpInfo(
        accountId: String,
        count: Int,
        lt: Long,
        hash: String
    ): ApiResponse<GetRawTransactions200Response?> {
    ...
    fun getRawTransactionsRequestConfig(
        accountId: String,
        count: Int,
        lt: Long,
        hash: String

...
class NFTApi(basePath: String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getNftCollectionItemsByAddresses(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest? = null): NftCollections {
        val localVarResponse = getNftCollectionItemsByAddressesWithHttpInfo(getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getNftCollectionItemsByAddressesWithHttpInfo(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): ApiResponse<NftCollections?> {
        val localVariableConfig = getNftCollectionItemsByAddressesRequestConfig(getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)

        return request<GetBlockchainRawAccountsRequest, NftCollections>(
            localVariableConfig
        )
    }

    fun getNftCollectionItemsByAddressesRequestConfig(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): RequestConfig<GetBlockchainRawAccountsRequest> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getNftItemsByAddresses(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest? = null): NftItems {
        val localVarResponse = getNftItemsByAddressesWithHttpInfo(getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getNftItemsByAddressesWithHttpInfo(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): ApiResponse<NftItems?> {
        val localVariableConfig = getNftItemsByAddressesRequestConfig(getBlockchainRawAccountsRequest = getBlockchainRawAccountsRequest)

        return request<GetBlockchainRawAccountsRequest, NftItems>(
            localVariableConfig
        )
    }

    fun getNftItemsByAddressesRequestConfig(getBlockchainRawAccountsRequest: GetBlockchainRawAccountsRequest?): RequestConfig<GetBlockchainRawAccountsRequest> {
        val localVariableBody = getBlockchainRawAccountsRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"

...
class NFTApi(basePath: String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) :
    ...
    fun getAccountNftHistoryWithHttpInfo(
        accountId: String,
        limit: Int,
        acceptLanguage: String?,
        beforeLt: Long?
    ): ApiResponse<NftOperations?> {
    ...
    fun getAccountNftHistoryRequestConfig(
        accountId: String,
        limit: Int,
        acceptLanguage: String?,
        beforeLt: Long?
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getItemsFromCollectionWithHttpInfo(
        accountId: String,
        limit: Int?,
        offset: Int?
    ...
    fun getItemsFromCollectionRequestConfig(
        accountId: String,
        limit: Int?,
        offset: Int?
    ): RequestConfig<Unit> {
    ...
    @Throws(IllegalStateException::class, IOException::class)
    @Deprecated(message = "This operation is deprecated.")
    fun getNftHistoryByIDWithHttpInfo(
        accountId: String,
        limit: Int,
        acceptLanguage: String?,
        beforeLt: Long?,
    ...
    @Deprecated(message = "This operation is deprecated.")
    fun getNftHistoryByIDRequestConfig(
        accountId: String,
        limit: Int,
        acceptLanguage: String?,
        beforeLt: Long?,

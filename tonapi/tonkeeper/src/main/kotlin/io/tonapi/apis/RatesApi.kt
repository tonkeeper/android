...
class RatesApi(basePath: String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) :
    ...
    fun getChartRatesWithHttpInfo(
        token: String,
        currency: String?,
        startDate: Long?,
        endDate: Long?,
        pointsCount: Int?
    ): ApiResponse<GetChartRates200Response?> {
    ...
    fun getChartRatesRequestConfig(
        token: String,
        currency: String?,
        startDate: Long?,
        endDate: Long?,

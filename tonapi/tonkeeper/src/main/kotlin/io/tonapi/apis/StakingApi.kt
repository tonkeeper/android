...
class StakingApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getStakingPoolHistory(accountId: String): GetStakingPoolHistory200Response {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getStakingPoolHistoryWithHttpInfo(accountId: String): ApiResponse<GetStakingPoolHistory200Response?> {
    ...
    fun getStakingPoolHistoryRequestConfig(accountId: String): RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getStakingPoolInfoWithHttpInfo(
        accountId: String,
        acceptLanguage: String?
    ): ApiResponse<GetStakingPoolInfo200Response?> {
    ...
    fun getStakingPoolInfoRequestConfig(
        accountId: String,
        acceptLanguage: String?
    ): RequestConfig<Unit> {
        val localVariableBody = null
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getStakingPoolsWithHttpInfo(
        availableFor: String?,
        includeUnverified: Boolean?,
        acceptLanguage: String?
    ): ApiResponse<GetStakingPools200Response?> {
    ...
    fun getStakingPoolsRequestConfig(
        availableFor: String?,
        includeUnverified: Boolean?,
        acceptLanguage: String?
    ): RequestConfig<Unit> {

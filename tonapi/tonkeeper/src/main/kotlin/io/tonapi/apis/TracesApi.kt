...
class TracesApi(basePath: String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getTraceWithHttpInfo(traceId: String): ApiResponse<Trace?> {
    ...
    fun getTraceRequestConfig(traceId: String): RequestConfig<Unit> {

...
class CheckBoxView @JvmOverloads constructor(
    ...
    private val checkDrawable: Drawable by lazy {
        val drawable = getDrawable(R.drawable.ic_done_bold_16)
    ...
    private val defaultPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = context.getColor(R.color.backgroundContentTint)
        style = Paint.Style.STROKE
        strokeWidth = strokeSize
    }

    private val activePaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = context.getColor(R.color.buttonPrimaryBackground)
    }
